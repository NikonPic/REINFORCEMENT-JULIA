function segway_rk4(xt::Vector{Float64}, ut::AbstractVector, dt::Number, seg::Segway = Segway_unmutable())
    xt1 = copy(xt)
...
"""
@inline function dxdt_segway(x::Vector{Float64}, u::AbstractVector, seg::Segway = Segway_unmutable())
    g = 9.81 #N/kg
