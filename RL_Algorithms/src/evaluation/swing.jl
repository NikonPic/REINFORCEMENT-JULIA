...
a = load("Results/10_31_swingup/1_all.jld2")["result"]
b = load("Results/10_31_swingup/2_all.jld2")["result"]
c = load("Results/10_31_swingup/3_all.jld2")["result"]
...
axis("off")
clf()
plot(0,0, label="REINFORCE")
plot(0,0)
plot(0,0)
plot(0,0,label="TRPO")
plot(0,0,label="PPO")
plot(0,0,label="PPO-soft")
axis("off")
legend(ncol = 4)
